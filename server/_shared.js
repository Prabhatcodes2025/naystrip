...
export function guard(req,res){
 ...
 const origin=req.headers.origin;if(origin&&!allowedOrigins.has(origin)&&process.env.NODE_ENV==="production"){json(res,403,{error:"Origin not allowed"});return false;}
