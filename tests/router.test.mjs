...
const expected=["admin/agents","admin/bookings","admin/content","admin/customers","admin/departures","admin/leads","admin/media","admin/notifications","admin/packages","admin/tours","admin/quotation-actions","admin/quotations","auth/admin","auth/portal","auth/recover","auth/register","auth/update-password","b2b/create-booking","b2b/dashboard","bookings/create","bookings/options","bookings/preview","bookings/verify","config","content","cron/reminders","departures","documents/booking","documents/itinerary","documents/quotation","documents/service-voucher","leads","packages","payments/create-order","payments/verify","payments/webhook","portal/cancel","portal/dashboard","portal/profile","quotations/view","settings"];
