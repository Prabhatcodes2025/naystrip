      ...
      <form onSubmit={handleSave} className="max-w-2xl space-y-6">
        ...
        <div className="rounded-2xl bg-white border border-navy-100 shadow-soft p-6 space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div><label className="label-field">Email</label><input type="email" value={form.email} onChange={(e) => update("email", e.target.value)} className="input-field" placeholder="name@example.com" /></div>
