  ...
  return <>
    ...
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#102f29] px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-7 flex flex-col items-center text-center text-white"><BrandLogo eager className="h-32 w-auto" /><p className="mt-2 text-sm text-white/50">Operations dashboard</p></div>
