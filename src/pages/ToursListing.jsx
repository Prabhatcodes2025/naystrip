...
export default function ToursListing() {
  ...
  return <>
    ...
    <section className="relative overflow-hidden bg-[#173c34] pb-16 pt-24 text-white"><div className="absolute -right-28 -top-24 h-96 w-96 rounded-full border border-white/10"/><div className="container-lg relative"><p className="eyebrow !text-orange-300">Domestic · Maharashtra</p><h1 className="mt-4 max-w-4xl font-display text-5xl leading-tight sm:text-7xl">Routes with a reason for every stop.</h1><p className="mt-5 max-w-2xl leading-7 text-white/70">Original day sequences from the supplied NaysTrip itineraries. Approved prices appear when available; every other route is quoted after live availability is checked.</p></div></section>
