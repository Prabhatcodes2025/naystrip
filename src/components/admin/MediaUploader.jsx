...
export default function MediaUploader({ label = "Image", value = [], onChange, scope = "general", multiple = false, context = "travel", compact = false }) {
